...
*/
static Circle helper_touching_circle( D2<SBasis> const &curve, double t, double tol=0.01 )
{
...
void extrapolate_join_internal(join_data const &jd, int alternative)
{
    ...
    Geom::Circle circle1 = helper_touching_circle(Geom::reverse(incoming.toSBasis()), 0.);
    Geom::Circle circle2 = helper_touching_circle(outgoing.toSBasis(), 0);
