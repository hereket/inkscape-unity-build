...
static Glib::ustring const filter_effects_dialog_prefs_path = "/dialogs/filters";
    ...
    , _settings_filter(Gtk::Orientation::VERTICAL)
{
    ...
    auto show_all_sources = Inkscape::Preferences::get()->getBool(filter_effects_dialog_prefs_path + "/dialogs/filters/showAllSources", false);
    ...
    _show_sources->signal_toggled().connect([=, this]{
        ...
        set_inputs(show_all);
        Inkscape::Preferences::get()->setBool(filter_effects_dialog_prefs_path + "/dialogs/filters/showAllSources", show_all);
    });

    _paned.set_position(Inkscape::Preferences::get()->getIntLimited(filter_effects_dialog_prefs_path + "/handlePos", 200, 10, 9999));
    _paned.property_position().signal_changed().connect([this]{
        Inkscape::Preferences::get()->setInt(filter_effects_dialog_prefs_path + "/handlePos", _paned.get_position());
    });
