        ...
        if (state_held_shift(state)) {
            if (state_held_ctrl(state)) {
                return format_tip(C_("Transform handle tip",
                    ...
                    "angle to %f° increments"), Inkscape::UI::snap_increment_degrees());
            }
            return C_("Transform handle tip", "<b>Shift</b>: rotate around the opposite corner");
        }
        if (state_held_ctrl(state)) {
            return format_tip(C_("Transform handle tip",
                "<b>Ctrl</b>: snap angle to %f° increments"), Inkscape::UI::snap_increment_degrees());
        }
        ...
        if (state_held_shift(state)) {
            if (state_held_ctrl(state)) {
                return format_tip(C_("Transform handle tip",
                    ...
                    "to %f° increments"), Inkscape::UI::snap_increment_degrees());
            }
            return C_("Transform handle tip", "<b>Shift</b>: skew about the rotation center");
        }
        if (state_held_ctrl(state)) {
            return format_tip(C_("Transform handle tip",
                "<b>Ctrl</b>: snap skew angle to %f° increments"), Inkscape::UI::snap_increment_degrees());
        }
        return C_("Transform handle tip",
