...
void gradient_editor_set_icon(Gtk::Button &btn, char const *pixmap)
{
    ...
    _prefs(prefs)
{
    ...
    gradient_editor_set_icon(_linear_btn, INKSCAPE_ICON("paint-gradient-linear"));
    gradient_editor_set_icon(_radial_btn, INKSCAPE_ICON("paint-gradient-radial"));

    auto& reverse = get_widget<Gtk::Button>(_builder, "reverseBtn");
    gradient_editor_set_icon(reverse, INKSCAPE_ICON("object-flip-horizontal"));
    reverse.signal_clicked().connect([=](){ reverse_gradient(); });

    gradient_editor_set_icon(_turn_gradient, INKSCAPE_ICON("object-rotate-right"));
    ...
    gradient_editor_set_icon(_add_stop, "list-add");
    ...
    gradient_editor_set_icon(_delete_stop, "list-remove");
