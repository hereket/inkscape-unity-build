...
void CanvasPrivate::launch_redraw()
{
    ...
    abort_flags.store((int)AbortFlags::ANone, std::memory_order_relaxed);
...
void Canvas::paint_widget(Cairo::RefPtr<Cairo::Context> const &cr)
{
    ...
    if (d->stores.mode() == Stores::Mode::ANone) {
