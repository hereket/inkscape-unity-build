...
static constexpr int COLOR_NOTEBOOK_XPAD = 2;
static constexpr int COLOR_NOTEBOOK_YPAD = 1;
...
void ColorNotebook::_initUI(bool no_alpha)
{
    ...
    _label->set_visible();
    _label->set_xalign(0);
    _label->set_margin_end(COLOR_NOTEBOOK_XPAD);
    ...
    _buttonbox->set_margin_start(COLOR_NOTEBOOK_XPAD);
    _buttonbox->set_margin_end(COLOR_NOTEBOOK_XPAD);
    _buttonbox->set_margin_top(COLOR_NOTEBOOK_YPAD);
    _buttonbox->set_margin_bottom(COLOR_NOTEBOOK_YPAD);
    ...
    _book->set_margin_top(COLOR_NOTEBOOK_YPAD);
    _book->set_margin_bottom(COLOR_NOTEBOOK_YPAD);
    _book->set_hexpand();
    _book->set_vexpand();
    ...
    gtk_widget_set_margin_start(rgbabox, COLOR_NOTEBOOK_XPAD);
    gtk_widget_set_margin_end(rgbabox, COLOR_NOTEBOOK_XPAD);
    gtk_widget_set_margin_top(rgbabox, COLOR_NOTEBOOK_YPAD);
    gtk_widget_set_margin_bottom(rgbabox, COLOR_NOTEBOOK_YPAD);
    ...
    attach(*Glib::wrap(_p), 2, 3, row, row + 1, Gtk::FILL, Gtk::FILL, COLOR_NOTEBOOK_XPAD, COLOR_NOTEBOOK_YPAD);
#endif
}
