...
PaintSelector::PaintSelector(GFillOrStroke kind, std::shared_ptr<Colors::ColorSet> colors)
...
PaintSelector::Mode PaintSelector::getModeForStyle(SPStyle const &style, GFillOrStroke kind)
{
