...
constexpr static int COLOR_SCALES_XPAD = 2;
constexpr static int COLOR_SCALES_YPAD = 2;
...
void ColorScales<MODE>::_initUI(bool no_alpha)
{
            ...
            MODE == SPColorScalesMode::OKLAB)
    {
        ...
        expander_icon->set_margin_start(2 * COLOR_SCALES_XPAD);
        expander_icon->set_margin_end(3 * COLOR_SCALES_XPAD);
        // Label
        ...
        wheel_frame->set_margin_start(2 * COLOR_SCALES_XPAD);
        wheel_frame->set_margin_end(COLOR_SCALES_XPAD);
        wheel_frame->set_margin_top(2 * COLOR_SCALES_YPAD);
        wheel_frame->set_margin_bottom(2 * COLOR_SCALES_YPAD);
    ...
    for (int i = 0; i < 5; i++) {
        ...
        _l[i]->set_margin_start(2 * COLOR_SCALES_XPAD);
        _l[i]->set_margin_end(COLOR_SCALES_XPAD);
        _l[i]->set_margin_top(COLOR_SCALES_YPAD);
        _l[i]->set_margin_bottom(COLOR_SCALES_YPAD);
        ...
        _s[i]->set_margin_start(COLOR_SCALES_XPAD);
        _s[i]->set_margin_end(COLOR_SCALES_XPAD);
        _s[i]->set_margin_top(COLOR_SCALES_YPAD);
        _s[i]->set_margin_bottom(COLOR_SCALES_YPAD);
        ...
        _b[i]->set_margin_start(COLOR_SCALES_XPAD);
        _b[i]->set_margin_end(COLOR_SCALES_XPAD);
        _b[i]->set_margin_top(COLOR_SCALES_YPAD);
        _b[i]->set_margin_bottom(COLOR_SCALES_YPAD);
