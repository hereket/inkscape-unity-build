...
struct ActionRelations<Inkscape::XML::EventAdd> {
    typedef Inkscape::XML::EventDel EventOpposite;
};

template <>
struct ActionRelations<Inkscape::XML::EventDel> {
    typedef Inkscape::XML::EventAdd EventOpposite;
};

template <typename A>
Inkscape::XML::Event *cancel_add_or_remove(A *action) {
    typedef typename ActionRelations<A>::EventOpposite EventOpposite;
    EventOpposite *opposite=dynamic_cast<EventOpposite *>(action->next);
