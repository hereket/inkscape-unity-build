...
static void sp_repr_css_add_components(SPCSSAttr *css, Inkscape::XML::Node const *repr, gchar const *attr);
...
void sp_repr_css_attr_unref(SPCSSAttr *css)
{
    ...
    Inkscape::GC::release((Inkscape::XML::Node *) css);
}
 ...
 */
SPCSSAttr *sp_repr_css_attr(Inkscape::XML::Node const *repr, gchar const *attr)
{
 ...
 */ 
static void sp_repr_css_attr_inherited_recursive(SPCSSAttr *css, Inkscape::XML::Node const *repr, gchar const *attr)
{
    const Inkscape::XML::Node *parent = repr->parent();
 ...
 */
SPCSSAttr *sp_repr_css_attr_inherited(Inkscape::XML::Node const *repr, gchar const *attr)
{
    g_assert(repr != nullptr);
    g_assert(attr != nullptr);
...
char const *sp_repr_css_property(SPCSSAttr *css, gchar const *name, gchar const *defval)
{
    ...
    char const *attr = ((Inkscape::XML::Node *)css)->attribute(name);
    return ( attr == nullptr
             ? defval
             : attr );
}
...
Glib::ustring sp_repr_css_property(SPCSSAttr *css, Glib::ustring const &name, Glib::ustring const &defval)
{
    ...
    char const *attr = ((Inkscape::XML::Node *)css)->attribute(name.c_str());
    if (attr) {
        retval = attr;
    }
...
void sp_repr_css_set_property(SPCSSAttr *css, gchar const *name, gchar const *value)
{
    ...
    ((Inkscape::XML::Node *) css)->setAttribute(name, value);
}
...
void sp_repr_css_unset_property(SPCSSAttr *css, gchar const *name)
{
    ...
    ((Inkscape::XML::Node *) css)->setAttribute(name, "inkscape:unset");
}
...
void sp_repr_css_set_property_double(SPCSSAttr *css, gchar const *name, double value)
{
    ...
    ((Inkscape::XML::Node *) css)->setAttributeCssDouble(name, value);
}
 ...
 */
void sp_repr_css_set(Inkscape::XML::Node *repr, SPCSSAttr *css, gchar const *attr)
{
    g_assert(repr != nullptr);
    g_assert(css != nullptr);
    g_assert(attr != nullptr);
 ...
 */
void sp_repr_css_change(Inkscape::XML::Node *repr, SPCSSAttr *css, gchar const *attr)
{
    g_assert(repr != nullptr);
    g_assert(css != nullptr);
    g_assert(attr != nullptr);
...
void sp_repr_css_change_recursive(Inkscape::XML::Node *repr, SPCSSAttr *css, gchar const *attr)
{
    g_assert(repr != nullptr);
    g_assert(css != nullptr);
    g_assert(attr != nullptr);
