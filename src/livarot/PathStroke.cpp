...
void livarot::Path::Stroke(Shape *dest, bool doClose, double width, JoinType join,
...
void livarot::Path::DoStroke(int off, int N, Shape *dest, bool doClose, double width, JoinType join,
		    ButtType butt, double miter, bool /*justAdd*/)
{
    if (N <= 1) {
        return;
...
void livarot::Path::DoButt(Shape *dest, double width, ButtType butt, Geom::Point pos, Geom::Point dir,
...
void livarot::Path::DoJoin (Shape *dest, double width, JoinType join, Geom::Point pos, Geom::Point prev,
        ...
        int *stNo, int *enNo)
{
    ...
    void
livarot::Path::DoLeftJoin (Shape * dest, double width, JoinType join, Geom::Point pos,
...
//        }
    ...
    void
livarot::Path::DoRightJoin (Shape * dest, double width, JoinType join, Geom::Point pos,
...
void livarot::Path::RecRound(Shape *dest, int sNo, int eNo, // start and end index
