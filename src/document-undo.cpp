...
class UndoCommitEvent : public InteractionEvent {
public:

    UndoCommitEvent(SPDocument *doc, const gchar *key, const gchar* event_description, const gchar *icon_name)
                                       ...
                                       Glib::ustring const &icon_name)
{
    ...
    Inkscape::Debug::EventTracker<UndoCommitEvent> tracker(doc, key, event_description.c_str(), icon_name.c_str());
