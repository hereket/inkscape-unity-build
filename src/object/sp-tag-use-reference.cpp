...
static void sp_tag_usepath_delete_self(SPObject *deleted, SPTagUsePath *offset);
...
SPTagUsePath::start_listening(SPObject* to)
{
    ...
    _delete_connection = to->connectDelete(sigc::bind(sigc::ptr_fun(&sp_tag_usepath_delete_self), this));
}
...
static void
sp_tag_usepath_delete_self(SPObject */*deleted*/, SPTagUsePath *offset)
{
