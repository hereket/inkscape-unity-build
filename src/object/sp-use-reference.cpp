...
static void sp_tag_usepath_href_changed(SPObject *old_ref, SPObject *ref, SPUsePath *offset);
...
SPUsePath::SPUsePath(SPObject* i_owner): SPUseReference(i_owner)
    , owner(i_owner)
{
    _changed_connection = changedSignal().connect(sigc::bind(sigc::ptr_fun(sp_tag_usepath_href_changed), this)); // listening to myself, this should be virtual instead
    user_unlink = nullptr;
}
...
static void
// sp_tag_usepath_href_changed(SPObject */*old_ref*/, SPObject */*ref*/, SPUsePath *offset)
sp_tag_usepath_href_changed(SPObject *, SPObject *, SPUsePath *offset)
{
