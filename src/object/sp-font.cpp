...
void SPFont::sort_glyphs() {
    ...
    std::vector<std::pair<SPGlyph*, Inkscape::XML::Node*>> glyphs;
    ...
    std::stable_sort(begin(glyphs), end(glyphs), [](const std::pair<SPGlyph*, Inkscape::XML::Node*>& a, const std::pair<SPGlyph*, Inkscape::XML::Node*>& b) {
