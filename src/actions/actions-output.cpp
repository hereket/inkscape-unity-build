...
{
    Glib::VariantType ABool(  Glib::VARIANT_TYPE_BOOL);
    ...
    gapp->add_action_with_parameter( "export-overwrite",         ABool,   sigc::bind(sigc::ptr_fun(&export_overwrite),    app));

    gapp->add_action_with_parameter( "export-area",              String, sigc::bind(sigc::ptr_fun(&export_area),         app));
    gapp->add_action_with_parameter( "export-area-drawing",      ABool,   sigc::bind(sigc::ptr_fun(&export_area_drawing), app));
    gapp->add_action_with_parameter( "export-area-page",         ABool,   sigc::bind(sigc::ptr_fun(&export_area_page),    app));
    gapp->add_action_with_parameter( "export-margin",            Int,    sigc::bind(sigc::ptr_fun(&export_margin),       app));
    gapp->add_action_with_parameter( "export-area-snap",         ABool,   sigc::bind(sigc::ptr_fun(&export_area_snap),    app));
    ...
    gapp->add_action_with_parameter( "export-id-only",           ABool,   sigc::bind(sigc::ptr_fun(&export_id_only),      app));

    gapp->add_action_with_parameter( "export-plain-svg",         ABool,   sigc::bind(sigc::ptr_fun(&export_plain_svg),    app));
    gapp->add_action_with_parameter( "export-dpi",               Double, sigc::bind(sigc::ptr_fun(&export_dpi),          app));
    gapp->add_action_with_parameter( "export-ignore-filters",    ABool,   sigc::bind(sigc::ptr_fun(&export_plain_svg),    app));
    gapp->add_action_with_parameter( "export-text-to-path",      ABool,   sigc::bind(sigc::ptr_fun(&export_text_to_path), app));
    ...
    gapp->add_action_with_parameter( "export-latex",             ABool,   sigc::bind(sigc::ptr_fun(&export_latex),        app));
    gapp->add_action_with_parameter( "export-use-hints",         ABool,   sigc::bind(sigc::ptr_fun(&export_use_hints),    app));
    ...
    gapp->add_action_with_parameter( "export-png-use-dithering", ABool,   sigc::bind(sigc::ptr_fun(&export_png_use_dithering), app));
