...
Inkscape::Colors::Color ink_cairo_surface_average_color(cairo_surface_t *surface)
{
    double r, g, b, a = 0.0;
...
Inkscape::Colors::Color ink_cairo_surface_average_color_premul(cairo_surface_t *surface)
{
    double r, g, b, a = 0.0;
    int count = ink_cairo_surface_average_color_internal(surface, r, g, b, a);
    auto color = Inkscape::Colors::Color(Inkscape::Colors::Space::Type::RGB, {r / count, g / count, b / count, a / count});
    color.normalize();
    return color;
}
